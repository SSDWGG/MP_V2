    ...
    <table cellpadding="0" align="center"
        ...
        <tr>
            <th valign="middle"
                ...
                <font face="微软雅黑" size="5" style="color: rgb(255, 255, 255); "></font>
            </th>
        </tr>
        <tr>
            <td style="word-break:break-all">
                <div style="padding:25px 35px 40px; background-color:#fff;opacity:0.8;">
                    ...
                    <!-- 中文 -->
                    <p>您好！感谢您使用 SSDWGG 的 MP_V2 项目，您的账号正在进行邮箱验证，</p>
                        <p>验证码为：<font color="#ff8c00">{0}</font>，</p>
                      <p>  有效期30分钟，请尽快填写验证码完成验证。(若不是本人操作，请忽略该条邮件)</p>
                    ...
                    <p>Hello! Thanks for using MP_V2 project your account is being authenticated by email,</p>
                    <p> the verification code is:<font color="#ff8c00">{0}</font>, </p>
                    <p>  valid for 30 minutes. Please fill in the verification code as soon as possible!</p>
                    <div style="width:100%;margin:0 auto;">
                        <div style="padding:10px 10px 0;border-top:1px solid #ccc;color:#747474;margin-bottom:20px;line-height:1.3em;font-size:12px;">
                            <p>SSDWGG</p>
                            <p>联系我们：13616549486</p>
                            <br>
                            <p>此为系统邮件，请勿回复<br>
